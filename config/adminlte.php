...
return [
    ...
    */
    ...
    'preloader' => [
        'enabled' => true,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/logotipo.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'       => 'Precauciones de administrador',
            'icon_color' => 'yellow',
            'url'        => 'precaucion',
        ],
        [
            'text'       => 'Pagina | Bienvenida',
            'icon_color' => 'cyan',
            'url'        => '/',
        ],
    ],
